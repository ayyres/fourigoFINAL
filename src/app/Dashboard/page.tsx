...
<div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out mb-8">
  ...
  <Table hoverable className="w-full text-base font-sans">
    <Table.Head className="bg-gray-100 dark:bg-gray-700 border-b-2 border-gray-300 dark:border-gray-600">
      <Table.HeadCell className="text-lg font-semibold text-gray-800 dark:text-gray-300">Nama Alat</Table.HeadCell>
      <Table.HeadCell className="text-lg font-semibold text-gray-800 dark:text-gray-300">Kategori</Table.HeadCell>
      <Table.HeadCell className="text-lg font-semibold text-gray-800 dark:text-gray-300">Status</Table.HeadCell>
      <Table.HeadCell className="text-lg font-semibold text-gray-800 dark:text-gray-300">Aksi</Table.HeadCell>
    </Table.Head>
    <Table.Body className="divide-y divide-gray-200 dark:divide-gray-700">
      <Table.Row className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-transform transform hover:scale-105 duration-300">
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Proyektor Epson</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Multimedia</Table.Cell>
        ...
        <Table.Cell className="py-4 px-6 flex space-x-3">
          <a href="/admin/manage-tools/edit/1" className="flex items-center space-x-1 text-blue-600 hover:text-blue-800 transition duration-300">
      ...
      <Table.Row className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-transform transform hover:scale-105 duration-300">
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Speaker JBL</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Audio</Table.Cell>
        <Table.Cell className="py-4 px-6">
        ...
        <Table.Cell className="py-4 px-6">
          <span className="text-gray-500 dark:text-gray-400">Tidak Tersedia</span>
        </Table.Cell>
      </Table.Row>
      <Table.Row className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-transform transform hover:scale-105 duration-300">
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Kamera Sony A7</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Fotografi</Table.Cell>
        <Table.Cell className="py-4 px-6">
          <span className="inline-block px-3 py-1 text-sm font-semibold text-green-600 bg-green-100 rounded-full dark:bg-green-800 dark:text-green-300">
            Tersedia
          </span>
        ...
        <Table.Cell className="py-4 px-6 flex space-x-3">
          <a href="/admin/manage-tools/edit/3" className="flex items-center space-x-1 text-blue-600 hover:text-blue-800 transition duration-300">
            <HiOutlinePencilAlt className="w-5 h-5" />
            <span>Edit</span>
          </a>
        </Table.Cell>
...
<div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out mb-8">
  <h3 className="mb-6 text-3xl font-extrabold tracking-tight text-gray-800 dark:text-white">Alat yang Disewa</h3>
  <Table hoverable className="w-full text-base font-sans">
    ...
    <Table.Body className="divide-y divide-gray-200 dark:divide-gray-700">
      <Table.Row className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-transform transform hover:scale-105 duration-300">
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Proyektor Epson</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Rizky Hidayat</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">12 Februari 2025</Table.Cell>
        <Table.Cell className="py-4 px-6">
          <span className="inline-block px-3 py-1 text-sm font-semibold text-red-600 bg-red-100 rounded-full dark:bg-red-800 dark:text-red-300">
            Belum Dikembalikan
          </span>
      ...
      <Table.Row className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-transform transform hover:scale-105 duration-300">
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Speaker JBL</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">Annisa Putri</Table.Cell>
        <Table.Cell className="py-4 px-6 text-gray-800 dark:text-gray-300">10 Februari 2025</Table.Cell>
        <Table.Cell className="py-4 px-6">
