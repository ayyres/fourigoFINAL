...
const UserForm: React.FC<UserFormProps> = ({
  ...
  useEffect(() => {
    if (initialData) {
      setFormData((prev) => ({
        ...prev,
        pelanggan_id: initialData.data.pelanggan_id,
        pelanggan_nama: initialData.data.pelanggan_nama || "",
        pelanggan_email: initialData.data.pelanggan_email || "",
        pelanggan_notelp: initialData.data.pelanggan_notelp || "",
        pelanggan_alamat: initialData.data.pelanggan_alamat || "",
      }));
    }
  }, [initialData]);
