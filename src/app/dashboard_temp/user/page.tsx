...
<section className="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        <div className="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200"> 
            <Button onClick={showPortalNotification} className="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">New</Button> 
            <span className="text-sm font-medium">Tunggu barang-barang baru yang akan datang</span> 
        </div>
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Sewa Alat Terjangkau di Rentronix</h1>
        <h2 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-3xl dark:text-white"> Solusi Tepat untuk Kebutuhan Anda!</h2>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Kami di Rentronix siap memenuhi kebutuhan sewa alat terbaik untuk Anda! Sewa dengan mudah, cepat, dan harga terbaik hanya di Rentronix. Pilih alat yang Anda butuhkan dan nikmati layanan terbaik kami!</p>
